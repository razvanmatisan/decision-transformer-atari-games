...
class AtariDataset():
    ...
    def compile_data(self, dataset_path=None, game=None, score_lb=0, score_ub=math.inf, max_nb_transitions=None):
        ...
        for t in shuffled_trajs:
            ...
            for pid in range(0, cur_traj_len):
                ...
                state = util.preprocess(cv2.imread(path.join(st_dir, str(pid) + '.png'), cv2.IMREAD_GRAYSCALE))
