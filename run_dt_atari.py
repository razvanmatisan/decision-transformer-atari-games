...
DATA_DIR = './revenge/atari_v1'
dataset = ds.AtariDataset(DATA_DIR)
obss, actions, returns, done_idxs, rtgs, timesteps = create_dataset(dataset=dataset, num_steps=args.num_steps)
...
# model.load_state_dict(torch.load("/home/razvanmatisan/AI_Projects/decision-transformer/atari/models/Pitfall/model_epoch1_normal.pth"))
# model.eval()

# !TODO: De schimbat lr: 6e-4
